...
if __name__ == '__main__':
    ...
    for cp in codePaths:
        ...
        if moduleName.endswith('_hw2'):
            student_id = moduleName.split('_')[0]
            moduleDict['multiAgents'] = loadModuleFile(moduleName, os.path.join(options.codeRoot, cp))
        else:
    ...
    if options.runTest != None:
        ...
        grade = evaluate(options.generateSolutions, options.testRoot, moduleDict,
